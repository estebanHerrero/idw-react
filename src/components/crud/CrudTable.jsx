...
const CrudTable = ({ alojamientos, deleteAlojamiento }) => {
  return <>
            ...
            : alojamientos.map((alojamiento, index) => {
              return  <tr key={index}>
                        ...
                        <td className='flex w-100'>
                          <button className='w-1/2 bg-transparent hover:bg-[#CDFADB] text-gray-700 font-semibold hover:text-gray-800 py-2 px-6 border border-gray-700 hover:border-none text-xl border-opacity-50 rounded text-opacity-80 mr-2 ml-2'>Actualizar</button>
